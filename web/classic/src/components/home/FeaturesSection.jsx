...
const features = [
  {
    ...
    title: 'LLM API',
    titleZh: '大语言模型',
    desc: 'Access powerful Chinese LLMs through a single OpenAI-compatible endpoint.',
    descZh: '通过统一的 OpenAI 兼容接口访问强大的中文大语言模型。',
    models: 'DeepSeek V4 · Doubao Pro · Seed Thinking',
  ...
  },
  {
    ...
    titleZh: '图片生成',
    desc: 'Create high-quality images with Seedream, powered by ByteDance.',
    descZh: '使用字节跳动 Seedream 模型生成高质量图片。',
    models: 'Seedream 4.0',
  ...
  },
  {
    ...
    titleZh: '视频生成',
    desc: 'Generate stunning videos from text or images with Seedance.',
    descZh: '使用 Seedance 模型，从文本或图片生成高质量视频。',
  ...
  },
  {
    ...
    titleZh: '语音合成',
    desc: 'Generate natural speech from text with Doubao TTS voices.',
    descZh: '使用豆包 TTS 语音模型，将文本转换为自然语音。',
    models: 'Doubao TTS · Seed TTS',
