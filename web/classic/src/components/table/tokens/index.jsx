...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-vancine-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-vancine-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-vancine-container') return true;
      return (
