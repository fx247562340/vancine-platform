...
const comparisons = [
  ...
  },
  {
    ...
    model: 'Kling V2',
    direct: '快手可灵 需中国手机号',
    directEn: 'Kuaishou Kling, needs Chinese phone number',
    vancine: '$0.15/段',
    note: '无需中国手机号',
    noteEn: 'No Chinese phone number',
    saving: '~35%',
  },
  {
    category: '3D 生成', categoryEn: '3D Generation',
    model: 'Trellis',
    direct: '需自行部署 GPU 服务器',
    directEn: 'Self-deploy on GPU servers',
    vancine: '$0.10/次',
    note: '即开即用，无需 GPU',
    noteEn: 'Ready to use, no GPU needed',
    saving: '',
  },
];
