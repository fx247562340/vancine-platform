            ...
            <div className='px-2 py-8'>
              <div className='space-y-3'>
                {status.wechat_login && (
                  <Button
                    theme='outline'
                    className='w-full h-12 flex items-center justify-center !rounded-full border border-semi-color-border hover:bg-semi-color-fill-0 transition-colors'
                    type='tertiary'
                    icon={
                ...
                <Button
                  theme='solid'
                  type='primary'
                  className='w-full h-12 flex items-center justify-center bg-semi-color-text-0 text-semi-color-bg-0 !rounded-full hover:bg-semi-color-text-1 transition-colors'
                      ...
                      {hasUserAgreement && (
                        <>
                          <a
                            ...
                            className='text-semi-color-primary hover:text-semi-color-primary-active mx-1'
                          >
                            {t('用户协议')}
                          </a>
                        </>
              ...
              {!status.self_use_mode_enabled && (
                <div className='mt-6 text-center text-sm'>
                  <Text>
                    ...
                    <Link
                      to='/register'
                      className='text-semi-color-primary hover:text-semi-color-primary-active font-medium'
                    >
                      {t('注册')}
                    </Link>
                  </Text>
            ...
            <div className='px-2 py-8'>
              {status.passkey_login && passkeySupported && (
                <Button
                  theme='outline'
                  type='tertiary'
                  className='w-full h-12 flex items-center justify-center !rounded-full border border-semi-color-border hover:bg-semi-color-fill-0 transition-colors mb-4'
                  icon={<IconKey size='large' />}
                  onClick={handlePasskeyLogin}
                  loading={passkeyLoading}
                >
