...
export function getI18nInitOptions() {
  return {
    ...
    resources: {
      en: { ...enTranslation, docs: enDocs },
      'zh-CN': { ...zhCNTranslation, docs: zhCNDocs },
      'zh-TW': { ...zhTWTranslation, docs: zhTWDocs },
      fr: { ...frTranslation, docs: frDocs },
      ru: { ...ruTranslation, docs: ruDocs },
      ja: { ...jaTranslation, docs: jaDocs },
      vi: { ...viTranslation, docs: viDocs },
    },
    fallbackLng: 'en',
    nsSeparator: false,
    interpolation: {
