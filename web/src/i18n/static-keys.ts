...
export const STATIC_I18N_KEYS = [
  ...
  // Homepage P11-B: Flagship / Available now + Hero stats.
  'Flagship models — available now',
  ...
  'JavaScript',
  'cURL',
  'OpenAI-compatible clients and agents',
  ...
  'Text to Speech',
  'Speech synthesis with OpenAI-compatible request shapes.',
  '3D generation',
  'Async 3D asset workflows documented in the Docs.',
  'One API key',
  'Connect once and use supported media models from one account.',
  'Unified account and balance',
  ...
  'Give tools and agents media capabilities through one API.',
  'Speech',
  ...
  'Which media models can I access?',
  ...
  // Image playground (dynamic t() keys from validation helpers)
  'This model does not support reference images',
  'Too many reference images',
  'Reference images must be PNG, JPEG, or WebP',
  'Reference images must be JPEG, PNG, BMP, TIFF, WebP, or GIF',
  ...
  'Number of images is out of range',
  'Generate',
  ...
  'Custom size exceeds the maximum pixel count',
  'Custom size aspect ratio is out of range',
