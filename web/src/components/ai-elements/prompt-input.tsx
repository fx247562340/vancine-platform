...
export const PromptInput = ({
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    Promise.all(
      ...
      .catch(() => {
        // Attachment preparation failed (e.g. blob URL conversion). Surface
        // the failure to the caller, keep attachments and text intact for a
        // retry, and do not submit.
        onError?.({
          code: 'attachment_conversion',
          message: t('Failed to prepare attachments.'),
        })
      })
  }
