...
export function useNotifications() {
  ...
  // Stable derivation: memoized on its real inputs so the unread-count memo
  // below does not recompute on every render (the previous inline slice
  // produced a fresh array per render).
