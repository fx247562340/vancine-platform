...
export function TwoFASetupDialog({
  ...
  // Main body render: initializing wins over missing setup data, which wins
  // over the loaded three-step content (single-layer priority chain, no
  // nesting).
  ...
  return (
    ...
    >
      <div className='space-y-4 py-4'>{bodyContent}</div>
    </Dialog>
  )
}
