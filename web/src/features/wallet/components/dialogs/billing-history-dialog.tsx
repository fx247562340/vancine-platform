...
const BILLING_HISTORY_SKELETON_KEYS = [
  'billing-history-skeleton-slot-01',
  'billing-history-skeleton-slot-02',
  'billing-history-skeleton-slot-03',
  'billing-history-skeleton-slot-04',
  'billing-history-skeleton-slot-05',
] as const
  ...
  if (loading) {
    recordsContent = (
      <div className='space-y-3'>
        {BILLING_HISTORY_SKELETON_KEYS.map((skeletonKey) => (
          <div key={skeletonKey} className='rounded-lg border p-3 sm:p-4'>
