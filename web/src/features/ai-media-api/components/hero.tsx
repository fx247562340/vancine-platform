...
import { AI_MEDIA_CTA_EVENT, getAiMediaCtaTarget } from '../lib/landing'

export interface AiMediaHeroProps {
...
/**
 * Above-the-fold introduction: restrained, verifiable positioning plus the
 * auth-aware primary CTA and an anchor link to the API examples.
 */
export function AiMediaHero(props: AiMediaHeroProps): ReactElement {
  const { t } = useTranslation()
  const ctaTarget = getAiMediaCtaTarget(props.isAuthenticated, props.search)

  return (
    <section
      aria-labelledby='ai-media-hero-title'
    ...
    >
      ...
      <div className='relative mx-auto flex max-w-3xl flex-col items-center gap-6'>
        ...
        <h1
          id='ai-media-hero-title'
          className='text-4xl font-bold tracking-tight md:text-5xl'
        >
          {t('Access Chinese AI media models through one API.')}
        </h1>
        ...
        <div className='flex flex-wrap items-center justify-center gap-3'>
          <Button
            ...
            onClick={() =>
              trackEvent(AI_MEDIA_CTA_EVENT, { location: 'ai_media_hero' })
            }
          >
            {props.isAuthenticated ? t('Go to Playground') : t('Get started')}
            <HugeiconsIcon
