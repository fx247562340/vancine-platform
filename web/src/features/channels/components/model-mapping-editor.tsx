...
export function ModelMappingEditor(props: ModelMappingEditorProps) {
  ...
  // Stable identities: the parse callback is only recreated when its real
  // inputs change, so the external-value effect below never re-runs from a
  // fresh function identity (which would loop: effect -> setRows -> render).
