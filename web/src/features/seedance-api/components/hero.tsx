...
/**
 * Above-the-fold introduction: what Seedance 2.5 on Vancine is for, plus the
...
export function Hero(props: HeroProps): ReactElement {
  ...
  return (
    <section
      aria-labelledby='seedance-hero-title'
    ...
    >
      ...
      <div className='relative mx-auto flex max-w-3xl flex-col items-center gap-6'>
        <p className='text-primary text-sm font-semibold tracking-wide uppercase'>
          {t('Async video generation, one developer path')}
        </p>
        <h1
          id='seedance-hero-title'
          className='text-4xl font-bold tracking-tight md:text-5xl'
        >
          {t('Seedance 2.5 API for Async Video Generation')}
        </h1>
