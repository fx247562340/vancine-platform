...
/**
 * A read-only code block with a copy button. Copy feedback is exposed both
 * visually (icon switch) and through an aria-live region, so success and
 * failure are announced to assistive technology alike.
 */
