...
import { OPENROUTER_ALTERNATIVE_FAQ } from '../lib/landing'

/**
 * Frequently asked questions, rendered from the fixed FAQ contract in
 * the landing lib. Base UI's Accordion provides keyboard support
 * natively.
 */
export function Faq(): ReactElement {
  ...
  return (
    <section
      id='faq'
      aria-labelledby='openrouter-alternative-faq-title'
      className='mx-auto w-full max-w-3xl px-4 py-16 md:px-6'
    >
      <h2
        id='openrouter-alternative-faq-title'
        className='mb-8 text-center text-3xl font-bold'
      >
        {t('Frequently asked questions')}
      </h2>
      <Accordion className='mt-8'>
        {OPENROUTER_ALTERNATIVE_FAQ.map((entry) => (
