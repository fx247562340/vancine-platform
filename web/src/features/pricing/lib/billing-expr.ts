...
// ParsedTier no longer carries sourceOffset: tiers are produced by the shared
// AST reader (compileBillingExpression + readTokenTierChain), whose TokenTier
// has no source positions. Request-rule groups keep their offset because
// tryParseRequestRuleExpr still computes real positions for duplicate factors.
