...
/**
 * A read-only code block that grows with its content (no fixed height)
 * and carries a copy button. Copy feedback is exposed both visually
 * (icon switch) and through an aria-live region.
 */
export function CopyableCode(props: CopyableCodeProps): ReactElement {
  ...
  return (
    <div className='relative'>
      <pre
        data-testid='fast-coding-models-code-block'
        className='bg-muted/60 border-border overflow-auto rounded-lg border p-4 pr-14 text-xs leading-relaxed'
      >
