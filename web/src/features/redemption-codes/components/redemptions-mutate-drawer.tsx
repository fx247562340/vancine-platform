  ...
  useEffect(() => {
    ...
    void getRedemption(redemptionId)
      ...
      .catch((error: unknown) => {
        ...
        setRedemptionLoadState('error')
        // Same localized fallback as the resolved-business-failure branch above
        // and as the sibling users drawer: a transport failure carries no
        // actionable message, so the caller's copy must be what the user sees.
