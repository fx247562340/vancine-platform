...
/**
 * Restrained Spotlight Card primitive (Default theme).
 *
 ...
 * via Tailwind v4's arbitrary media variant
...
export const SpotlightCard = forwardRef<HTMLDivElement, Props>(
  function SpotlightCard({ children, className = '', style, interactive = true }, forwardedRef) {
    ...
    const wrapperClass = [
      ...
      // Real border + base color, so the card reads as a layered tile even
      // before any hover.
