...
const comparisons = [
  ...
  },
  {
    model: 'Kimi K2.5',
    category: 'LLM',
    direct: 'Moonshot, needs Chinese account',
    directZh: 'Moonshot，需中国账号',
    vancine: '$0.50/M tokens',
    note: 'Direct global access',
    noteZh: '全球直接访问',
    saving: '~25%',
  },
  {
  ...
  },
  {
    model: 'Hailuo 2.3',
    category: 'Video',
    direct: 'MiniMax, needs Chinese account',
    directZh: 'MiniMax，需中国账号',
    vancine: '$0.08/clip',
    note: 'No Chinese identity needed',
    noteZh: '无需中国身份',
    saving: '~40%',
  },
  {
