# Vancine Electron Desktop App

This directory contains the Electron wrapper for Vancine, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., vancine-macos)
cp ../vancine-macos ../vancine
```
...
- Store database in `../data/vancine.db`
...
### Database Location
- **Development**: `../data/vancine.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Vancine/data/`
  - Windows: `%APPDATA%/Vancine/data/`
  - Linux: `~/.config/Vancine/data/`
