...
func printHelp() {
	fmt.Println("Vancine Platform " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Based on OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: Vancine - https://github.com/QuantumNous/new-api")
	fmt.Println("Usage: vancine [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
