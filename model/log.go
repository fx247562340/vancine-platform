...
type Log struct {
	Id                int    `json:"id" gorm:"index:idx_created_at_id_v2,priority:2;index:idx_user_id_id,priority:2"`
	UserId            int    `json:"user_id" gorm:"index;index:idx_user_id_id,priority:1"`
	CreatedAt         int64  `json:"created_at" gorm:"bigint;index:idx_created_at_id_v2,priority:1;index:idx_created_at_type"`
