...
每个候选模型按以下维度评分，总分 40 分：

| 维度 | 分值 | 说明 |
|------|------|------|
| 热度 | 0–8 | 国内/海外讨论热度 |
| 海外需求 | 0–8 | 海外开发者真实需求强度 |
| API/商业可用性 | 0–8 | API 稳定性、商业转售可行性 |
| Vancine 差异化 | 0–6 | 相比竞品的独特价值 |
| 实证速度和成本 | 0–5 | 实测延迟和价格竞争力 |
| 渠道匹配 | 0–5 | 与现有渠道和受众的契合度 |
