...
build-frontend:
	...
	@cd $(FRONTEND_DIR) && npm install --no-audit --no-fund && DISABLE_ESLINT_PLUGIN='true' VITE_REACT_APP_VERSION=$$(cat ../../VERSION) npm run build

build-frontend-classic:
	@echo "Building classic frontend..."
	@cd $(FRONTEND_CLASSIC_DIR) && npm install --legacy-peer-deps --no-audit --no-fund && VITE_REACT_APP_VERSION=$$(cat ../../VERSION) npm run build
...
dev-web:
	...
	@cd $(FRONTEND_DIR) && npm install --no-audit --no-fund && npm run dev

dev-web-classic:
	@echo "Starting classic frontend dev server..."
	@cd $(FRONTEND_CLASSIC_DIR) && npm install --legacy-peer-deps --no-audit --no-fund && npm run dev
