...
var seoPublicRouteCases = []seoPublicRouteCase{
	...
	},
	{
		...
		wantDescription:      "Integrate Vancine text, image, and video models using one OpenAI-compatible API key.",
		wantCanonical:        "https://vancine.com/docs",
		wantOGTitle:          "Vancine API Documentation | OpenAI-Compatible Chinese Models",
		wantOGDescription:    "Integrate Vancine text, image, and video models using one OpenAI-compatible API key.",
		wantOGURL:            "https://vancine.com/docs",
		wantTwitterTitle:     "Vancine API Documentation | OpenAI-Compatible Chinese Models",
		wantTwitterDesc:      "Integrate Vancine text, image, and video models using one OpenAI-compatible API key.",
		wantTwitterCardValue: "summary",
	},
	{
	...
	{
		path:                 "/ai-media-api",
		wantTitle:            "AI Media API: Image & Video | Vancine",
		wantDescription:      "Access Chinese AI media models through one API. Image and video generation with one API key and unified billing.",
		wantCanonical:        "https://vancine.com/ai-media-api",
		wantOGTitle:          "Chinese AI Media Models Through One API",
		wantOGDescription:    "Generate images and videos with one API key and documented endpoints.",
		wantOGURL:            "https://vancine.com/ai-media-api",
		wantTwitterTitle:     "AI Media API: Image & Video",
		wantTwitterDesc:      "Access Chinese AI media models through one API. Image and video generation with one API key and unified billing.",
		wantTwitterCardValue: "summary",
	},
	{
